    ...
    switch (e.target.value) {
      ...
      case "a-z":
        await fetchData({
          url: `${URL_PROJECTS}?${QUERY_FILTER_PROJECTS}=${QUERY_FILTER_PROJECTS_BY_A_TO_Z}`,
          queryFilterData:
            QUERY_FILTER_PROJECTS + "=" + QUERY_FILTER_PROJECTS_BY_A_TO_Z,
      ...
      case "z-a":
        await fetchData({
          url: `${URL_PROJECTS}?${QUERY_FILTER_PROJECTS}=${QUERY_FILTER_PROJECTS_BY_Z_TO_A}`,
          queryFilterData:
            QUERY_FILTER_PROJECTS + "=" + QUERY_FILTER_PROJECTS_BY_Z_TO_A,
          actionType: "FIRST_FETCH_DATA",
        });
        break;
      ...
      <main>
        ...
        {!projectsState.isFetching && projectsState.projects?.length > 0 && (
          <>
            ...
            <Cards allData={projectsState.projects} onClickGoTo={"/project"} />
            <LoadMoreButton
