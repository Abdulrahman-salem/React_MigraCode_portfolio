        ...
        {showDescription ? (
          <div className="description_text">
            <div className="text">
              ...
              <p>
                ...
                in the tech sector and people with a migration background who
                are eager to work in the tech industry. Founded in 2019, we are
              ...
              <button className="button slide-right2">See more</button>
            </div>
          ...
          <div className="description_text">
            <div className="text">
              ...
              <p>
                In the last 2 months of every MigraCode course, students work in
                groups on a final project in which they combine all the
                knowledge they have gained during the first 6 months of learning
                through our program. Besides that, we often also offer
                side-projects to gain experience and build their portfolio.
                Below you can find some project examples made by MigraCode
                students.
              </p>
              <button className="button slide-right2">See more</button>
            </div>
