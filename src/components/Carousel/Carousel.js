          ...
          {showDescription ? (
            <div className="description_text">
              <div className="text">
                ...
                <p>
                  ...
                  background who are eager to work in the tech industry. Founded
                  in 2019, we are cooperating with other code schools in Europe
                  to build a large community of companies and students to foster
                  both labor integration as well as social inclusion.
                </p>
            ...
            <div className="description_text">
              <div className="text">
                ...
                <p>
                  In the last 2 months of every MigraCode course, students work
                  in groups on a final project in which they combine all the
                  knowledge they have gained during the first 6 months of
